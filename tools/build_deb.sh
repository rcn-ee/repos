...
build () {
	if [ -f ${localdir}/incoming/${suite}/${debian_pkg_name}_${debian_version}/${dsc_file} ] ; then
		echo "-----------------"
		echo "sbuild ${options} http://192.168.1.98/farm/incoming/${suite}/${debian_pkg_name}_${debian_version}/${dsc_file}"
		echo "-----------------"
		sudo sbuild ${options} http://192.168.1.98/farm/incoming/${suite}/${debian_pkg_name}_${debian_version}/${dsc_file}
