...
debian_dl_9="${dl_mirror}/${node_red_can}-${v6}.tar.xz"
debian_dl_10="${dl_mirror}/${node_red_gpio}-${v6}.tar.xz"
debian_dl_11="${dl_mirror}/${node_red_mjpgcamera}-${v6}.tar.xz"
debian_dl_12="${dl_mirror}/${node_red_particle}-${v6}.tar.xz"
debian_dl_13="${dl_mirror}/${node_red_dashboard}-${v6}.tar.xz"
debian_dl_14="${dl_mirror}/${node_red_serial}-${v6}.tar.xz"
