...
${git} "${wdir}/0009-wpasupplicant_band_selection_f0d0a5d2.patch"
${git} "${wdir}/0010-wpasupplicant_band_selection_a1b790eb.patch"
${git} "${wdir}/0011-wpasupplicant_band_selection_8b2b718d.patch"
${git} "${wdir}/0012-wpasupplicant_band_selection_aa517ae2.patch"
number=12 ; git format-patch -${number} -o ${wdir}/
