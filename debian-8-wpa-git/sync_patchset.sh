...
${git} "${wdir}/0007-hostapd_fix-hostapd-operation-without-hw_mode-driver.patch"
${git} "${wdir}/0008-wpasupplicant_fix-systemd-unit-dependencies.patch"
${git} "${wdir}/0009-wpasupplicant_P2P-Validate-SSID-element-length-befor.patch"
${git} "${wdir}/0010-wpasupplicant_band_selection_f0d0a5d2.patch"
${git} "${wdir}/0011-wpasupplicant_band_selection_a1b790eb.patch"
${git} "${wdir}/0012-wpasupplicant_band_selection_8b2b718d.patch"
${git} "${wdir}/0013-wpasupplicant_band_selection_aa517ae2.patch"
