...
builds () {
	...
	package_name="extra-cmake-modules" ; package_version="${package_name}_5.14.0-2" ; check_http
}
...
mesa () {
	...
	package_name="libvdpau" ; package_version="${package_name}_1.1.1-1" ; check_http

	site="${debian_pool}/main/m"
	package_name="mesa" ; package_version="${package_name}_11.0.0-1" ; check_http
}
...
qt5_kde () {
	...
	package_name="solid" ; package_version="${package_name}_5.14.0-2" ; check_http

	site="${debian_pool}/main/k"
	package_name="kcoreaddons" ; package_version="${package_name}_5.14.0-1" ; check_http
	package_name="kguiaddons" ; package_version="${package_name}_5.14.0-1" ; check_http
	package_name="kwindowsystem" ; package_version="${package_name}_5.14.0-1" ; check_http
}
...
package_name="chromium-browser" ; package_version="${package_name}_44.0.2403.89-0ubuntu1.1195" ; check_http
