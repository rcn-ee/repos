...
mesa () {
	...
	package_name="llvm-toolchain-3.8" ; package_version="${package_name}_3.8.1-13" ; check_http
	package_name="llvm-toolchain-3.9" ; package_version="${package_name}_3.9-4" ; check_http
