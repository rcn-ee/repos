...
mesa () {
	...
	package_name="mesa" ; package_version="${package_name}_10.5.7-1" ; check_http
}
...
qt5_apps () {
	...
	package_name="cmst" ; package_version="cmst_2015.06.03-1" ; check_http
...
qt5_lxqt () {
	...
	package_name="lxqt-globalkeys" ; package_version="${package_name}_0.9.0-8" ; check_http
	package_name="lxqt-notificationd" ; package_version="${package_name}_0.9.0-8%2bexp1" ; check_http
	package_name="lxqt-sudo" ; package_version="${package_name}_0.1.0-4" ; check_http
	...
	package_name="lxqt-policykit" ; package_version="${package_name}_0.9.0-5" ; check_http
	...
	package_name="lxqt-config" ; package_version="${package_name}_0.9.0-16" ; check_http
