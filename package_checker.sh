...
qt5_lxqt () {
	...
	package_name="lxqt-notificationd" ; package_version="${package_name}_0.9.0-6%2bexp1" ; check_http
	...
	package_name="lxqt-powermanagement" ; package_version="${package_name}_0.9.0-7%2bexp1" ; check_http
	...
	package_name="lxqt-config" ; package_version="${package_name}_0.9.0-9%2bexp1" ; check_http
	...
	package_name="lxqt-common" ; package_version="${package_name}_0.9.1-7%2bexp1" ; check_http
}
