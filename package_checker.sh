...
important () {
	...
	package_name="firmware-nonfree" ; package_version="${package_name}_20161130-3" ; check_http
}
...
mesa () {
	...
	package_name="llvm-toolchain-3.9" ; package_version="${package_name}_3.9.1-8" ; check_http
	#https://packages.debian.org/source/sid/llvm-toolchain-4.0
	package_name="llvm-toolchain-4.0" ; package_version="${package_name}_4.0-5" ; check_http
	...
	package_name="libdrm" ; package_version="${package_name}_2.4.81-1" ; check_http
	...
	package_name="mesa" ; package_version="${package_name}_17.1.2-2" ; check_http
...
ubuntu () {
	...
	filter="16.04"
	package_name="chromium-browser" ; package_version="${package_name}_58.0.3029.110-0ubuntu0.16.04.1281" ; check_http
