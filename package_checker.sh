...
mesa () {
	...
	package_name="llvm-toolchain-3.8" ; package_version="${package_name}_3.8.1-12" ; check_http
	package_name="llvm-toolchain-3.9" ; package_version="${package_name}_3.9-1" ; check_http
	package_name="llvm-toolchain-snapshot" ; package_version="${package_name}_4.0~svn279916-1" ; check_http

	site="${debian_pool}/main/libc"
	filter="0.2"
	package_name="libclc" ; package_version="${package_name}_0.2.0+git20160907-1" ; check_http

	site="${debian_pool}/main/libd"
	package_name="libdrm" ; package_version="${package_name}_2.4.70-1" ; check_http
...
ubuntu () {
	...
	package_name="chromium-browser" ; package_version="${package_name}_52.0.2743.116-0ubuntu0.16.04.1.1250" ; check_http
