...
mesa () {
	...
	package_name="mesa" ; package_version="${package_name}_17.0.1-1" ; check_http
...
ubuntu () {
	...
	filter="16.04"
	package_name="chromium-browser" ; package_version="${package_name}_56.0.2924.76-0ubuntu0.16.04.1268" ; check_http
