...
NODERED_BEAGLEBONE="node-red-node-beaglebone-0.1.6-acb6fe5-v0.12.13.tar.xz"
    NODERED_BB_UPM="node-red-node-bb-upm-0.0.1-8d217ab-v0.12.13.tar.xz"
   NODERED_MONGODB="node-red-node-mongodb-0.0.5-49692b3-v0.12.13.tar.xz"
...
stretch_version="~bpo90+20160616+1"
xenial_version="~bpo1604+20160616+1"
